...
type GlobalSharedSubscriber = typeof globalThis & {
  __seavideoSharedSubscriber?: SharedSubscriber
}

const globalForSharedSubscriber = globalThis as GlobalSharedSubscriber

export function getSharedSubscriber() {
  if (!globalForSharedSubscriber.__seavideoSharedSubscriber) {
    globalForSharedSubscriber.__seavideoSharedSubscriber = new SharedSubscriber()
  }
  return globalForSharedSubscriber.__seavideoSharedSubscriber
}
