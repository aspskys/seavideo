...
export default async function globalSetup() {
  ...
  execSync('docker compose -p seavideo-test -f docker-compose.test.yml down -v --remove-orphans', {
    cwd: process.cwd(),
    stdio: 'inherit',
  })

  execSync('docker compose -p seavideo-test -f docker-compose.test.yml up -d --remove-orphans', {
    cwd: process.cwd(),
    stdio: 'inherit',
  })
